...
<title>Assessoria de Imprensa Portal Pets</title>
...
<body>
<form action="../Copy%20of%20anfibios/adicionar_animal.asp" method="post">
...
align="center" width="347"> 
        <input type="text" name="raca" size="40" style="font-family: Verdana; font-size: 8 pt; border-style: solid; border-width: 1">
      </td>
    </tr>
    <tr  bgcolor="#DEDEDE"> 
      <td   
align="right" width="171" bgcolor="#DEDEDE"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">arquivo:</font></b></td>
      <td   
align="center" width="347"> 
        <input type="text" name="arquivo" size="40" style="font-family: Verdana; font-size: 8 pt; border-style: solid; border-width: 1">
      </td>
    </tr>
    <tr  bgcolor="#DEDEDE"> 
      <td   
align="right" width="171" bgcolor="#DEDEDE"  valign="top"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Corpo 
        da Not&iacute;cia:</font></b></td>
      <td   
align="center" width="347"> 
        <textarea name="animal" cols="40" style="font-family: Verdana; font-size: 8 pt; border-style: solid; border-width: 1" rows="5"></textarea>
      </td>
    </tr>
    <tr  bgcolor="#DEDEDE"> 
      <td   
