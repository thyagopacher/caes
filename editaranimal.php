...
include "Conexao.php";
$conexao = new Conexao();
$sql = "select * from anfibios where id=" . $_GET["id"];
...
<html lang="pt-br">
    ...
    <body>
        <div align="center">
            <p><font face="Verdana, Arial, Helvetica, sans-serif"><i><b><font size="2">Editar 
                        Noticia </font></b></i></font></p>
            <p>&nbsp;</p>
        </div>
        <form action="../Copy%20of%20anfibios/editando.asp" method="post">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="521"    bgcolor="#BEBEBE">
                ...
                <tr  bgcolor="#DEDEDE"> 
                    ...
                    <td   
                        align="center" width="347"> 
                        <textarea name="animal" cols="40" style="font-family: Verdana; font-size: 8 pt; border-style: solid; border-width: 1" rows="5"><?=$rs["animal"]?></textarea>
                    </td>
                </tr>
                <tr  bgcolor="#DEDEDE"> 
                    <td   
